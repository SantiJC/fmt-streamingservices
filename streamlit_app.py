...
try:
  ...
  'european', 'family', 'fantasy', 'history', 'horror', 'music', 'reality', 
  'romance', 'scifi', 'sport', 'thriller', 'war', 'western', 'age_certification', 'id', 'América del Norte', 'América del Sur', 'África', 'Europa', 'Oceanía', 'Asia']).sort_values(by="imdb_score", ascending=False)
